...
namespace Maticsoft.BLL
{
	...
	{
		private readonly Maticsoft.DAL.City dal=new Maticsoft.DAL.City();
		public City()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Maticsoft.Model.City GetModelByCache(string CityID)
		{
			...
			return (Maticsoft.Model.City)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.City> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.City> DataTableToList(DataTable dt)
		{
			List<Maticsoft.Model.City> modelList = new List<Maticsoft.Model.City>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.City model;
