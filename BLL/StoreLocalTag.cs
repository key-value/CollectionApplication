...
namespace Maticsoft.BLL
{
    ...
    {
        private readonly Maticsoft.DAL.StoreLocalTag dal = new Maticsoft.DAL.StoreLocalTag();
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public Maticsoft.Model.StoreLocalTag GetModelByCache(string KeyID)
        {

            string CacheKey = "StoreLocalTagModel-" + KeyID;
            ...
            return (Maticsoft.Model.StoreLocalTag)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<Maticsoft.Model.StoreLocalTag> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Maticsoft.Model.StoreLocalTag> DataTableToList(DataTable dt)
        {
            List<Maticsoft.Model.StoreLocalTag> modelList = new List<Maticsoft.Model.StoreLocalTag>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Maticsoft.Model.StoreLocalTag model;
