...
namespace Maticsoft.DAL
{
	...
	public partial class BusPhotoAlbumTable
	{
		...
		public bool Exists(string BusPhotoAlbumID)
		{
			...
			strSql.Append("select count(1) from BusPhotoAlbumTable");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into BusPhotoAlbumTable(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update BusPhotoAlbumTable set ");
        ...
        public bool Remove(string strWhere)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from BusPhotoAlbumTable ");
		...
		public Maticsoft.Model.BusPhotoAlbumTable GetModel(string BusPhotoAlbumID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 BusinessID,BusPhotoAlbumID,AlbumName,AlbumDesc,IsDefault from BusPhotoAlbumTable ");
			strSql.Append(" where BusPhotoAlbumID=@BusPhotoAlbumID ");
			SqlParameter[] parameters = {
					new SqlParameter("@BusPhotoAlbumID", SqlDbType.VarChar,50)			};
			parameters[0].Value = BusPhotoAlbumID;

			Maticsoft.Model.BusPhotoAlbumTable model=new Maticsoft.Model.BusPhotoAlbumTable();
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.BusPhotoAlbumTable DataRowToModel(DataRow row)
		{
			Maticsoft.Model.BusPhotoAlbumTable model=new Maticsoft.Model.BusPhotoAlbumTable();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM BusPhotoAlbumTable ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from BusPhotoAlbumTable T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "BusPhotoAlbumTable";
