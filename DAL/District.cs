...
namespace Maticsoft.DAL
{
	...
	public partial class District
	{
		...
		public Maticsoft.Model.District GetModel(string DistrictID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 DistrictID,DistrictName,CityID,SortID from District ");
			strSql.Append(" where DistrictID=@DistrictID ");
			SqlParameter[] parameters = {
					new SqlParameter("@DistrictID", SqlDbType.NVarChar,50)			};
			parameters[0].Value = DistrictID;

			Maticsoft.Model.District model=new Maticsoft.Model.District();
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.District DataRowToModel(DataRow row)
		{
			Maticsoft.Model.District model=new Maticsoft.Model.District();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select DistrictID,DistrictName,CityID,SortID ");
