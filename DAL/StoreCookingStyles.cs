...
namespace Maticsoft.DAL
{
	...
	public partial class StoreCookingStyles
	{
		...
		public bool Exists(string KeyID)
		{
			...
			strSql.Append("select count(1) from StoreCookingStyles");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into StoreCookingStyles(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update StoreCookingStyles set ");
		...
		public bool Delete(string KeyID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from StoreCookingStyles ");
			strSql.Append(" where KeyID=@KeyID ");
			SqlParameter[] parameters = {
					new SqlParameter("@KeyID", SqlDbType.NVarChar,50)			};
			parameters[0].Value = KeyID;
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM StoreCookingStyles ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from StoreCookingStyles T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "StoreCookingStyles";
